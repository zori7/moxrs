  ...
  <el-container id="app">
    <el-header>
      <el-menu :default-active="$route.path" :router="true" class="el-menu-demo" mode="horizontal">
        ...
        <el-submenu index="1" v-if="$store.getters.loggedIn">
          <template slot="title">
        ...
        <el-menu-item v-if="!$store.getters.loggedIn" index="login" :route="{ name: 'login' }">Log in</el-menu-item>
        <el-menu-item v-if="!$store.getters.loggedIn" index="register" :route="{ name: 'register' }">Register</el-menu-item>
      </el-menu>
    </el-header>
    <el-main>
